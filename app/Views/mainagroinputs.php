        ...
        <!-- <div class="col-lg-9"> -->
          <div class="p-lg-5 p-4 bg-white">
            ...
            <h5 id="paragraph">Paragraph</h5>
              ...
              <hr>
            <img src="images/one.jpg" alt="image" class="one-image">
            <link rel="stylesheet" href="<?= base_url('assets/styles.css') ?>">
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td><em>A-MightAgrochemical</em></td>
                    <td>Fertilizer,Agro-chemical,tools&equipment</td>
                    
                  </tr>
                  <tr>
                    <td>AOneAgroEnterprise</td>
                    <td>Fertilizer,Agro-Chemical,Tools&Equipment</td>
              ...
              <p>  <img src="images/two.jpg" alt="image" class="two-image"></p>
              <hr>
